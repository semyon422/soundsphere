...
---@operator call: rizu.library.ComputeDataProvider
...
---@param locations rizu.library.Locations
---@param fs fs.IFilesystem
function ComputeDataProvider:new(chartfilesRepo, chartsRepo, locationsRepo, locations, fs)
