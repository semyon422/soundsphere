...
function test.osumania_v1_v1(t)
	...
	t:tdeq({match(tvs)}, {Timings("osumania", 0), Subtimings("scorev", 1)})

	tvs = from_abcd(-0.185, -0.148, 0.148, 0.148) -- (t - 0.003)
	t:tdeq({match(tvs)}, {Timings("osumania", 1), Subtimings("scorev", 1)})
end
...
function test.osumania_v1_v4(t)
	...
	t:tdeq({match(tvs)}, {Timings("osumania", 0.4), Subtimings("scorev", 1)})

	tvs = from_abcd(-0.186, -0.149, 0.125, 0.125) -- (t - 0.002)
	t:tdeq({match(tvs)}, {Timings("osumania", 0.7), Subtimings("scorev", 1)})
end
...
function test.osumania_v2_v1(t)
	...
	t:tdeq({match(tvs)}, {Timings("osumania", 0), Subtimings("scorev", 2)})

	tvs = from_abcd(-0.185, -0.148, 0.124, 0.124) -- (t - 0.003)
	tvs.LongNoteEnd = {hit = {-0.222, 0.186}, miss = {-0.2775, 0.186}}
	t:tdeq({match(tvs)}, {Timings("osumania", 1), Subtimings("scorev", 2)})
end
...
function test.osumania_v2_v2(t)
	...
	t:tdeq({match(tvs)}, {Timings("osumania", 0.4), Subtimings("scorev", 2)})
end
