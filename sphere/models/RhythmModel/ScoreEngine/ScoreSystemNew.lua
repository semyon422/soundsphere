...
local ShortScoreNote = {}
ShortScoreNote.passed = 0
ShortScoreNote.missed = 0

local LongScoreNote = {}
LongScoreNote.clear = {}
LongScoreNote.startPassedPressed = {}
LongScoreNote.startMissedPressed = {}
LongScoreNote.startMissed = {}
LongScoreNote.clear.startPassedPressed = 0
LongScoreNote.clear.startMissed = 0
LongScoreNote.clear.startMissedPressed = 0
LongScoreNote.startPassedPressed.startMissed = 0
LongScoreNote.startPassedPressed.endMissed = 0
LongScoreNote.startPassedPressed.endPassed = 0
LongScoreNote.startMissedPressed.endMissedPassed = 0
LongScoreNote.startMissedPressed.startMissed = 0
LongScoreNote.startMissedPressed.endMissed = 0
LongScoreNote.startMissed.startMissedPressed = 0
LongScoreNote.startMissed.endMissed = 0
